function ident_table = network_identifiability_old(template_file, cleaned_file, compare_file, orig_file, funcmask, GM_mask, smooth_kern, network_names, output_dir)
