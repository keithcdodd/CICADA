function qc_corrs_table = grab_corr_sampling(Edge_Edge_corr, FD_GM_corr, DVARS_GM_corr, Outbrain_Outbrain_corr, WMCSF_WMCSF_corr, CSF_CSF_corr, NotGM_NotGM_corr, GM_GM_corr, samps)
...
qc_corrs_array = [Edge_Edge_corr, FD_GM_corr, DVARS_GM_corr, Outbrain_Outbrain_corr, WMCSF_WMCSF_corr, CSF_CSF_corr, NotGM_NotGM_corr, GM_GM_corr];
qc_corrs_labels = {'Edge_Edge_Corr', 'FD_GM_Corr', ...
    'DVARS_GM_Corr', 'Outbrain_Outbrain_Corr', 'WMCSF_WMCSF_Corr', ...
    'CSF_CSF_Corr', 'NotGM_NotGM_Corr', 'GM_GM_Corr'};
