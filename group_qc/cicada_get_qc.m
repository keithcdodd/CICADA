...
Edge_Edge_median = median(Edge_Edge_corr, "omitnan");
Edge_Edge_sd = std(Edge_Edge_corr, "omitnan");
FD_GM_median = median(FD_GM_corr, "omitnan");
FD_GM_sd = std(FD_GM_corr, "omitnan");
DVARS_GM_median = median(DVARS_GM_corr, "omitnan");
DVARS_GM_sd = std(DVARS_GM_corr, "omitnan");
Outbrain_Outbrain_median = median(Outbrain_Outbrain_corr, "omitnan");
Outbrain_Outbrain_sd = std(Outbrain_Outbrain_corr, "omitnan");
WMCSF_WMCSF_median = median(WMCSF_WMCSF_corr, "omitnan");
WMCSF_WMCSF_sd = std(WMCSF_WMCSF_corr, "omitnan");
CSF_CSF_median = median(CSF_CSF_corr, "omitnan");
CSF_CSF_sd = std(CSF_CSF_corr, "omitnan");
NotGM_NotGM_median = median(NotGM_NotGM_corr, "omitnan");
NotGM_NotGM_sd = std(NotGM_NotGM_corr, "omitnan");
GM_GM_median = median(GM_GM_corr, "omitnan");
GM_GM_sd = std(GM_GM_corr, "omitnan");
...
if cicada == 1
    ...
    qc_array = [{cleaned_file, cleaned_file_info.name, sub_id, ses_id, task_name, adjusted, meanRMS, ...
        ...
        Outbrain_Outbrain_median, Outbrain_Outbrain_sd, Edge_Edge_median, Edge_Edge_sd, Suscept_Suscept_median, Suscept_Suscept_sd, NotGM_mean_var, ...
    ...
    qc_labels = ['image_path', 'image_names', 'subject', 'session', 'task', 'manually_adjusted', 'meanRMS', ...
        ...
        'Edge_Edge_median', 'Edge_Edge_sd', 'Suscept_Suscept_median', 'Suscept_Suscept_sd', 'NotGM_mean_var', 'GM_mean_var', 'CSF_mean_var', 'WMCSF_mean_var', ...
    ...
    qc_array = {cleaned_file, cleaned_file_info.name, sub_id, ses_id, task_name, meanRMS, ...
        ...
        Suscept_Suscept_median, Suscept_Suscept_sd, NotGM_mean_var, GM_mean_var, ...
