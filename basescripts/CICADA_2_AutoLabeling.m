...
reset_tr_8p_command = ['fslmerge -tr ', prefix, '_8p_', suffix, ' ', prefix, '_8p_', suffix, ' ', num2str(TR)];
[~, ~] = call_fsl(reset_tr_8p_command);
reset_tr_9p_command = ['fslmerge -tr ', prefix, '_8p_', suffix, ' ', prefix, '_9p_', suffix, ' ', num2str(TR)];
[~, ~] = call_fsl(reset_tr_9p_command);
